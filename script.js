let studentData1 = [{"id":1,"first_name":"Chadwick","last_name":"Ayre","email":"cayre0@cam.ac.uk","gender":"Male","img_src":"https://robohash.org/corporisquiaperiam.png?size=50x50&set=set1","class":11,"marks":18,"passing":false,"city":"Moorreesburg"},
...
let studentData = studentData1.map(student => {
    if (student.passing === true) {
        return { ...student, passing: "Passed" };
    } else {
        return { ...student, passing: "Failed" };
    }
});

let tableBody = document.querySelector("#myTableBody");
tableBody.innerHTML ="";
...
let marksBtn = document.querySelector("#btn3");
marksBtn.addEventListener("click",function marksSort(e){
    e.preventDefault();
...
let classBtn = document.querySelector("#btn5");
classBtn.addEventListener("click",function classSort(e){
    e.preventDefault();
...
let sortBtn1 = document.querySelector("#btn1");
sortBtn1.addEventListener("click",function Sort(e){
    e.preventDefault();
    studentData.sort((a,b) => {
        let fullNameA = a.last_name + a.first_name;
        let fullNameB = b.last_name + b.first_name;
...
let sortBtn2 = document.querySelector("#btn2");
sortBtn2.addEventListener("click",function Sort(e){
    e.preventDefault();
    studentData.sort((a,b) => {
        let fullNameA = a.last_name + a.first_name;
        let fullNameB = b.last_name + b.first_name;
...
let sortBtn6 = document.querySelector("#btn6");
sortBtn6.addEventListener("click",function Sort(e){
    e.preventDefault();
    studentData.sort((a,b) => {
...
let sortBtn4 = document.querySelector("#btn4");
sortBtn4.addEventListener("click",function Sort(e){
    e.preventDefault();
    studentData.sort((a,b) => {
...
searchButton.addEventListener("click",function search(e){
    e.preventDefault();
    let searchTerm = document.querySelector("#search-bar");

    let searchTermValue  = searchTerm.value.toLowerCase();
    ...
    let filteredData = studentData.filter(student => {
        ...
        if (firstName.includes(searchTermValue)) {
            return true; 
        }
        if (lastName.includes(searchTermValue)) {
            return true;  
        }
        if (email.includes(searchTermValue)) {
            return true; 
        }
